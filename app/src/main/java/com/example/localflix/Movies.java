...
public class Movies extends Fragment {
    ...
    static List<MoviesModel> moviesModelList=new ArrayList<>();;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        moviesAdapter = new MoviesAdapter(getContext(), moviesModelList);
    ...
    public static void prepareMovies(List<MoviesModel> moviesModels){
        //moviesAdapter = new MoviesAdapter(mContext, moviesModelList);
        moviesModelList.clear();
        Log.d("switch","here"+moviesModels.size());
        try {
            for (int i = 0; i < moviesModels.size(); i++) {
                moviesModelList.add(moviesModels.get(i));
            }
        }catch (Exception e)
        {
